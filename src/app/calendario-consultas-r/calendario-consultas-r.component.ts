...
@Component({
  ...
  templateUrl: './calendario-consultas-r.component.html',
  styleUrls: ['./calendario-consultas-r.component.css']
})
export class CalendarioConsultasRComponent implements OnInit {
  calendarOptions: any = {
