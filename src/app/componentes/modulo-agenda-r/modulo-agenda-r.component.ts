...
@Component({
  selector: 'app-modulo-agenda-r',
  templateUrl: './modulo-agenda-r.component.html',
  styleUrls: ['./modulo-agenda-r.component.css']
})
export class ModuloAgendaRComponent implements OnInit {
  ...
  constructor(
    ...
    @Optional() private dialogRef: MatDialogRef<ModuloAgendaRComponent>
  ) {
  ...
  onPacienteSelected(paciente: any) {
    this.consultaForm.patchValue({
      pacienteInput: `${paciente.nombre} ${paciente.apellido_paterno} ${paciente.apellido_materno}`, // Mostrar nombre completo
      edad: paciente.edad,
