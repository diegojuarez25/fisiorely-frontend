...
@Component({
  selector: 'app-modulo-gastos-r',
  templateUrl: './modulo-gastos-r.component.html',
  styleUrls: ['./modulo-gastos-r.component.css']
})
export class ModuloGastosRComponent implements OnInit {
  gastos: any[] = [];
  gastoForm: FormGroup;
  editMode = false;
  gastoEdit: any = null;
