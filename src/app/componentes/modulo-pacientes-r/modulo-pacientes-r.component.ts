...
@Component({
  selector: 'app-modulo-pacientes-r',
  templateUrl: './modulo-pacientes-r.component.html',
  styleUrls: ['./modulo-pacientes-r.component.css']
})
export class ModuloPacientesRComponent implements OnInit, AfterViewInit {
  pacientes: any[] = [];
