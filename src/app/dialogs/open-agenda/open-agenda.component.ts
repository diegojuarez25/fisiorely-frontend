...
@Component({
  selector: 'app-open-agenda',
  templateUrl: './open-agenda.component.html',
  styleUrl: './open-agenda.component.css'
})

export class OpenAgendaComponent implements OnInit {
  ...
  constructor(
    ...
    @Optional() private dialogRef: MatDialogRef<OpenAgendaComponent>
  ) {
